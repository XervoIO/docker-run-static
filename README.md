# Modulus Static Docker Run Image
...
``` text
$ docker pull onmodulus/docker-run-static:latest
$ docker run -v /host-folder:/mnt -p 80:8080 onmodulus/docker-run-static:latest start
```
...
``` text
$ docker run -v /host-folder:/mnt -p 80:8080 onmodulus/docker-run-static:latest
```
